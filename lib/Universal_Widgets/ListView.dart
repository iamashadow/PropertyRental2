...
class MyListView extends StatelessWidget {
  const MyListView(
      {super.key, required this.controller, required this.properList});
  final OurPropertiseController controller;
  final List<PropertyInfo> properList;

  @override
  Widget build(BuildContext context) {
    return GridView.builder(
      shrinkWrap: true,
      itemCount: min(6, properList.length),
          ...
          child: Card(
            child: Column(
              ...
              children: [
                ...
                Stack(
                  children: [
                    properList[index].propertyImages == null
                        ? Container(
                            width: 1.sw * 0.3,
                            height: 1.sh * 0.3,
                    ...
                    Positioned(
                        ...
                        right: 5,
                        child: Card(
                          color: properList[index].propertyStatus == "Sold"
                              ? Colors.red
                              : properList[index].propertyStatus == "Available"
                                  ? Colors.green
                                  : properList[index].propertyStatus == "Rented"
                                      ? Colors.deepPurple
                                      : null,
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: CustomText(
                              title: properList[index].propertyStatus ?? "N/A",
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      //Property Name
                      CustomText(
                        title: properList[index].propertyName!,
                        fontSize: 20,
                      ...
                      CustomText(
                        title:
                            "Added on ${DateFormat('dd MMM yyyy').format(properList[index].createdAt!)}",
                        fontSize: 10,
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  CustomText(
                                    title:
                                        properList[index].bathrooms.toString(),
                                    fontSize: 20,
                                  ),
                                ],
                              ),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  //BedRooms
                                  CustomText(
                                    title: properList[index].area.toString(),
                                    fontSize: 20,
                                  ),
                                ],
                              ),
                      ...
                      //PropertyStaus
                      CustomText(
                        title: properList[index].propertyType!,
                        fontColor: Colors.blueGrey,
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          CustomText(
                            title: "BDT ${properList[index].propertyPrice}",
