...
class ProeprtyRequestsAndApprovedProperties extends StatefulWidget {
  ...
  @override
  State<ProeprtyRequestsAndApprovedProperties> createState() => _ProeprtyRequestsAndApprovedPropertiesState();
}

class _ProeprtyRequestsAndApprovedPropertiesState extends State<ProeprtyRequestsAndApprovedProperties> with SingleTickerProviderStateMixin {
        ...
        children: [
          ...
          Container(
            ...
            child: TabBar(
                ...
                tabs: const [
                  Tab(text: "Property Approve Requests",),
