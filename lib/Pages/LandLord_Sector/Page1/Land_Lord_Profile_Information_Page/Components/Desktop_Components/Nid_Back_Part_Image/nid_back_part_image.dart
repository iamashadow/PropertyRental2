...
class NidBackPartImage extends StatelessWidget {
  const NidBackPartImage({super.key});
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: ColorManager.kasmiriBlue)
              ),
              child: controller.NidBackImageUrl == null || controller.NidBackImageUrl!.isEmpty
                  ? Center(
                child: Column(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        fit: BoxFit.cover,
                        image: NetworkImage(controller.NidBackImageUrl!,)
                    )
                ),
              ),
            ),
